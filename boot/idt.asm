...
isr_basic:
	...
	add esp, 4 ; discard the value pushed by ISR on the stack
	sti
	iret
...
idt:
	dw isr_0, 8, 0x8e00, 0x0000 ; Handler Name | Segemet Selector (8 - Kernel\'s code seg) | Present  = 0
	dw isr_1, 8, 0x8e00, 0x0000															  ;| Privilge Level = 0
	dw isr_2, 8, 0x8e00, 0x0000															  ;| Descripor size = 32-bit
	dw isr_3, 8, 0x8e00, 0x0000 														  ;| Gate-type = Interrupt
